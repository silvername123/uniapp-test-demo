	...
	<view class="uni-easyinput" :class="{'uni-easyinput-error':msg}" :style="boxStyle">
		<view class="uni-easyinput__content" :class="inputContentClass" :style="inputContentStyle">
			...
			<input v-else :type="type === 'password'?'text':type" class="uni-easyinput__content-input"
				...
				placeholder-class="uni-easyinput__placeholder-class uni-easyinput__placeholder-input" :disabled="disabled" :maxlength="inputMaxlength"
...
<style lang="scss">
	...
	.uni-easyinput__placeholder-class {
		...
		font-size: 12px;
		// font-weight: 200;
		&.uni-easyinput__placeholder-input{
			line-height: 1.2;
		}
	}
