<template>
	<view class="uni-forms-item"
		:class="['is-direction-' + (labelPosition||localLabelPos) ,border?'uni-forms-item--border':'' ,border && isFirstBorder?'is-first-border':'']">
		<slot name="label">
			<view class="uni-forms-item__label" :class="{'no-label':!label && !isRequired}"
				:style="{width:(labelPosition||localLabelPos)==='top'?'auto':localLabelWidth,justifyContent: localLabelAlign}">
